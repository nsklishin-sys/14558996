...
(function() {
  ...
  const MENU_SHEET_HTML =
    ...
    '<aside class="m-menu" id="mobileMenu" role="menu" aria-label="Меню разделов">' +
      ...
      '<a class="m-menu-item" href="/saved.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>Сохранённое</a>' +
