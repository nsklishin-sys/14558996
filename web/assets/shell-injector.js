...
(function () {
  ...
  <div class="profile-dd-wrap">
    ...
    <div class="profile-dd" id="profileDD">
      ...
      <div class="pdd-body">
        ...
        <a href="/analytics" class="pdd-item">
  ...
  <a class="nav-item" href="/dashboard" data-match="^/dashboard|^/news-detail">
    <svg viewBox="0 0 24 24"><path d="M4 6h16M4 12h16M4 18h10"/></svg>
    <span>Новости</span>
  </a>
  <a class="nav-item" href="/projects" data-match="^/projects|^/project-detail">
    <svg viewBox="0 0 24 24"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
    <span>Проекты</span>
  </a>
  <a class="nav-item" href="/events" data-match="^/events|^/event-detail">
    <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
    <span>Мероприятия</span>
  </a>
  <a class="nav-item" href="/exhibitions" data-match="^/exhibition">
    <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7"/><rect x="5" y="9" width="14" height="12" rx="1"/><path d="M9 21V13h6v8"/></svg>
    <span>Выставки</span>
  </a>
  <a class="nav-item" href="/jobs" data-match="^/jobs|^/job-detail|^/resume-detail">
  ...
  <a class="nav-item" href="/catalog" data-match="^/catalog|^/product-detail|^/service-detail">
    <svg viewBox="0 0 24 24"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
    <span>Товары и услуги</span>
  </a>
  <a class="nav-item" href="/emarket" data-match="^/emarket">
  ...
  <a class="nav-item" href="/forum" data-match="^/forum">
    <svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
    <span>Форум</span>
  </a>
  <a class="nav-item" href="/companies" data-match="^/companies|^/company-detail|^/my-company">
    <svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
    <span>Компании</span>
  </a>
  <a class="nav-item" href="/communities" data-match="^/communities|^/community-detail|^/my-community">
    <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
    <span>Сообщества</span>
  </a>
  <div class="nav-group">Профиль</div>
  <a class="nav-item" href="/chat" data-match="^/chat">
    <svg viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="2,4 12,13 22,4"/></svg>
    <span>Чат</span>
    <span class="nav-badge" id="navChatUnread" style="display:none"></span>
  </a>
  <a class="nav-item" href="/profile" data-match="^/profile">
    <svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
    <span>Профиль</span>
  </a>
  <div class="nav-bottom">
    <a class="nav-item" href="/settings" data-match="^/settings" style="color:var(--gmt)">
      ...
      .then(function (d) {
        ...
        if (isPriv) {
          ...
          warn.innerHTML =
            ...
            '<a href="/admin" style="flex-shrink:0;padding:7px 14px;border-radius:8px;background:#8A5A00;color:#fff;text-decoration:none;font-size:12px;font-weight:600;white-space:nowrap">Консоль разделов</a>';
